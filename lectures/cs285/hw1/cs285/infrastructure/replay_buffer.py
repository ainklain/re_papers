...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        batch_idx = np.random.permutation(len(self.obs))[:batch_size]
        return self.obs[batch_idx], self.acs[batch_idx], self.rews[batch_idx], self.next_obs[batch_idx], self.terminals[batch_idx]
